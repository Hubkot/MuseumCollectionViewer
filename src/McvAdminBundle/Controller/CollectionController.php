...
class CollectionController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $collections = $em->getRepository('McvAdminBundle:Collection')->findAll();

        return $this->render('McvAdminBundle:collection:index.html.twig', array(
    ...
    public function newAction(Request $request)
    {
        ...
        $form = $this->createForm('McvAdminBundle\Form\CollectionType', $collection);
        ...
        return $this->render('McvAdminBundle:collection:new.html.twig', array(
    ...
    public function showAction(Collection $collection)
    {
        ...
        return $this->render('McvAdminBundle:collection:show.html.twig', array(
            'collection' => $collection,
    ...
    {
        $deleteForm = $this->createDeleteForm($collection);
        $editForm = $this->createForm('McvAdminBundle\Form\CollectionType', $collection);
        ...
        return $this->render('McvAdminBundle:collection:edit.html.twig', array(
            'collection' => $collection,
